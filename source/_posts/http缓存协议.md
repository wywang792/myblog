...
![image-20200430202446870](./assets/http缓存协议/image-20200430202446870.png)
...
![image-20200430210430455](./assets/http缓存协议/image-20200430210430455.png)
...
![image-20200430212052228](./assets/http缓存协议/image-20200430212052228.png)![image-20200430214301507](./assets/http缓存协议/image-20200430214301507.png)
...
![image-20200430225326001](./assets/http缓存协议/image-20200430225326001.png)
...
![image-20200501075337464](./assets/http缓存协议/image-20200501075337464.png)
...
![image-20200501080330131](./assets/http缓存协议/image-20200501080330131.png)
...
![image-20200501082103089](./assets/http缓存协议/image-20200501082103089.png)
...
![image-20200501083702987](./assets/http缓存协议/image-20200501083702987.png)
...
![image-20200501084258712](./assets/http缓存协议/image-20200501084258712.png)

当收到服务器响应时，会自动根据缓存指令进行处理

![image-20200501084559394](./assets/http缓存协议/image-20200501084559394.png)